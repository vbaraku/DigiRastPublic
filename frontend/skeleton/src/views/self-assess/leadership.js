...
export default function Leadership() {
    ...
    const getQuestions = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/questions?thematicElement=Leadership & Governance Practices');
    ...
    return (
        <MainCard title="Self-assessment - Leadership & Governance Practices">
