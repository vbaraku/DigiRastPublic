...
export default function Content() {
    ...
    const getQuestions = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/questions?thematicElement=Content and Curricula');
    ...
    return (
        <MainCard title="Self-assessment - Content and Curricula">
