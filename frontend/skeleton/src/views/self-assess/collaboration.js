...
export default function Collaboration() {
    ...
    const getQuestions = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/questions?thematicElement=Collaboration and Networking');
    ...
    return (
        <MainCard title="Self-assessment - Collaboration and Networking ">
