...
export default function Assessment() {
    ...
    const getQuestions = async () => {
        try {
            const response = await axios.get('http://localhost:8080/api/questions?thematicElement=Assessment practices');
    ...
    return (
        <MainCard title="Self-assessment - Assessment practices">
